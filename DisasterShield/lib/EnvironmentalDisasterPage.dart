...
class EnvironmentalDisasterPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Environment Disasters'),
        centerTitle: true,
        elevation: 0,
      ),
      body: Container(
  ...
  DisasterInfo(
    ...
    learnMoreUrl: 'https://en.wikipedia.org/wiki/Oil_spill',
  ),
  DisasterInfo(
    'Deforestation',
    ...
    learnMoreUrl: 'https://www.google.com/search?q=Deforestation',
  ),
  DisasterInfo(
    ...
    learnMoreUrl: 'https://www.google.com/search?q=Mining+induced+landslide',
  ),
  DisasterInfo(
    'Coastal erosion',
    ...
    learnMoreUrl: 'https://www.google.com/search?q=Coastal+erosion',
  ),
  DisasterInfo(
    ...
    learnMoreUrl: 'https://www.google.com/search?q=Coral+reef+destruction',
  ),
  DisasterInfo(
    'Water pollution',
    'Sudden loss of electrical power over an area.',
    ...
    learnMoreUrl: 'https://www.google.com/search?q=Water+pollution',
  ),
  DisasterInfo(
    'Air pollution',
    'Sudden loss of electrical power over an area.',
    ...
    learnMoreUrl: 'https://www.google.com/search?q=Air+pollution',
  ),
  DisasterInfo(
    'Garbage landslides',
    'Sudden loss of electrical power over an area.',
    ...
    learnMoreUrl: 'https://www.google.com/search?q=Garbage+landslides',
  ),
...
class DisasterDetailPage extends StatelessWidget {
 ...
 Future<void> launchURL(String url) async {
  ...
  // You need to define _buildSection too for this to be complete.
}